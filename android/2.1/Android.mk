...
ifeq ($(PLATFORM_VERSION),$(filter $(PLATFORM_VERSION), 12 12L S))
LOCAL_CFLAG += -DCAR_POWER_DAEMON_SUPPORTED
endif

ifeq ($(PLATFORM_VERSION),$(filter $(PLATFORM_VERSION), 13 T Tiramisu))
LOCAL_CFLAG += -DCAR_POWER_DAEMON_SUPPORTED
endif
